 ...
 * @author Sergio Morel
 */
public class CircularByteBufferList implements List<Byte>
{
	/**
	 ...
	 * @author Sergio Morel
	 */
	public CircularByteBufferList(int size)
	{
	 ...
	 * @author Sergio Morel
	 */
	public CircularByteBufferList(byte... byteArray)
	{
	...
	@Override
	public CircularByteBufferListIterator iterator()
	{
		return new CircularByteBufferListIterator(this);
	}
	...
	public boolean equals(Object object)
	{
		...
		CircularByteBufferList byteBuffer = (CircularByteBufferList)object;
		...
		CircularByteBufferListIterator iterator1 = this.iterator();
		CircularByteBufferListIterator iterator2 = byteBuffer.iterator();
